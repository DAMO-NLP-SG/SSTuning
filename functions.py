...
class Data_processor_wrapper_v3:
    def __init__(self,tokenizer,label_num=15,option_type='str',pad_labels=1,max_length=512,num_sample=0,num_workers=4,list_for_test='all',json_file = '../data_testing/label_dict_classification.json'):
    ...
    def load_datasets(self):
        ...
        for d in self.list_for_test:
            if d in self.list_dataset:
                dataset = load_dataset("csv", data_files=f'./data_testing/{d}/test.csv')['train']
